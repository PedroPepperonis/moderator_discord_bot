...
class Database:
    ...
    def delete_message_from_user(self, server_name, server_id, channel_name, channel_id, user_id):
        with self.connection:
            return self.cursor.execute('INSERT INTO '
